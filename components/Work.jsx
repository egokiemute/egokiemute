  ...
  const work = [
    {
      ...
      description: "Frontend Engineer & Engineering Lead",
      link: "https://flextable.co",
    },
    {
      name: "Vimerge",
      icon: "/assets/work-2.png",
      description: "A premium gospel fashion brand.",
      link: "https://vimerge.shop",
    },
    {
      name: "Halocore",
      icon: "/assets/work-3.png",
      description: "Space booking web app for Halocare.",
      link: "https://halocore.co",
    },
    {
      name: "Coach Kemi",
      icon: "/assets/work-4.png",
      description: "A personal portfolio and booking web app.",
      link: "https://www.iamcoachkemi.com/",
    },
  ];
  return (
